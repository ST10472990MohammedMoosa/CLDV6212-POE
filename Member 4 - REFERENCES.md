...
**Student Number:** ST10472990  
**GitHub:** `ST10472990MohammedMoosa`  
**Part 1 Area:** Project foundation, Azure Functions, Azure Table Storage, menu CRUD, validation, Azurite, Postman testing and documentation.
...
# Member 2 - Kaden Remley

**Student Number:** ST10472838  
**GitHub:** `Jason4x`  
**Part 1 Area:** Menu test automation, Postman Collection Runner, menu integration verification, documentation and code review.
...
Microsoft (2025) *Introduction to Azure Files*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/azure/storage/files/storage-files-introduction (Accessed: 2 September 2026).

Microsoft (2025) *Develop for Azure Files with .NET*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/azure/storage/files/storage-dotnet-how-to-use-files (Accessed: 2 September 2026).

Microsoft (2026) *Azure.Storage.Files.Shares namespace*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/dotnet/api/azure.storage.files.shares?view=azure-dotnet (Accessed: 2 September 2026).

Microsoft (2026) *ShareClient class (Azure.Storage.Files.Shares)*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/dotnet/api/azure.storage.files.shares.shareclient?view=azure-dotnet (Accessed: 2 September 2026).

Microsoft (2026) *ShareDirectoryClient class (Azure.Storage.Files.Shares)*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/dotnet/api/azure.storage.files.shares.sharedirectoryclient?view=azure-dotnet (Accessed: 2 September 2026).

Microsoft (2026) *ShareFileClient class (Azure.Storage.Files.Shares)*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/dotnet/api/azure.storage.files.shares.sharefileclient?view=azure-dotnet (Accessed: 2 September 2026).

Microsoft (2026) *ShareFileClient.UploadRange method*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/dotnet/api/azure.storage.files.shares.sharefileclient.uploadrange?view=azure-dotnet (Accessed: 2 September 2026).

Microsoft (2026) *ShareFileClient.Download method*. Microsoft Learn. Available at: https://learn.microsoft.com/en-us/dotnet/api/azure.storage.files.shares.sharefileclient.download?view=azure-dotnet (Accessed: 2 September 2026).
...
CircleCI (2026) *Configuration reference*. CircleCI Docs. Available at: https://circleci.com/docs/configuration-reference/ (Accessed: 10 September 2026).
